...
class HomePageForm(ModelForm):
    ...
    link1 = forms.CharField(label=u'焦点图1链接', widget=forms.Select)
    link2 = forms.CharField(label=u'焦点图2链接', widget=forms.Select)
    link3 = forms.CharField(label=u'焦点图3链接', widget=forms.Select)
    link4 = forms.CharField(label=u'焦点图4链接', widget=forms.Select)
