...
urlpatterns = patterns('microsite.views',
    ...
    url(r'^join/add', 'add_edit_join'),
    url(r'^join/(?P<item_id>\d+)/edit', 'add_edit_join'),
    url(r'^join/(?P<item_id>\d+)/delete', 'join_delete'),
    url(r'^trend/add', 'add_edit_trend'),
    url(r'^trend/(?P<item_id>\d+)/edit', 'add_edit_trend'),
    url(r'^trend/(?P<item_id>\d+)/delete', 'trend_delete'),
    url(r'^team/add', 'add_edit_team'),
    url(r'^team/(?P<item_id>\d+)/edit', 'add_edit_team'),
    url(r'^team/(?P<item_id>\d+)/delete', 'team_delete'),
