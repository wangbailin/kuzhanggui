	...
	var imageDialog = function( editor, dialogType ) {
			...
			var resetSize = function( dialog ) {
					...
					updatePreview( dialog );
                        ...
                        var resetSize720 = function( dialog ) {
                                        var oImageOriginal = dialog.originalElement;
                                        if ( oImageOriginal.getCustomData( 'isReady' ) == 'true' ) {
                                                var widthField = dialog.getContentElement( 'info', 'txtWidth' ),
                                                        heightField = dialog.getContentElement( 'info', 'txtHeight' );
                                                widthField && widthField.setValue( 720 );
                                                heightField && heightField.setValue( oImageOriginal.$.height );
                                        }
                                        updatePreview( dialog );
                                };
							...
							children: [
								...
								children: [
									...
									html: '<div>' +
										...
										'" class="cke_btn_locked cke_btn_unlocked" id="' + btnLockSizesId + '" role="checkbox"><span class="cke_icon"></span><span class="cke_label">' + editor.lang.image.lockRatio + '</span></a>' +
